...
%% ---------------------------------------------------------------
%% NOTE: e-mail addresses below follow the firstnamelastname@iut-dhaka.edu
%% pattern. Verify each against your actual institutional address.
%% ---------------------------------------------------------------
\author{Ifti Akkas}
\authornote{Student ID: 210041111.}
\affiliation{
...
\author{Syed Huzzatullah Mihad}
\authornote{Student ID: 210041218.}
\affiliation{
  \institution{Department of Computer Science and Engineering\\
  Islamic University of Technology (IUT), OIC}
  \city{Dhaka}
...
\email{syedhuzzatullahmihad@iut-dhaka.edu}

\author{Rafid Ahmed}
\authornote{Student ID: 210041232.}
\affiliation{
  \institution{Department of Computer Science and Engineering\\
  Islamic University of Technology (IUT), OIC}
  \city{Dhaka}
...
\email{rafidahmed@iut-dhaka.edu}

\author{Zawad Bin Shoukat}
\authornote{Student ID: 210041257.}
\affiliation{
  \institution{Department of Computer Science and Engineering\\
  Islamic University of Technology (IUT), OIC}
  \city{Dhaka}
...
\email{zawadbinshoukat@iut-dhaka.edu}

\author{Muntasir Hossain}
\authornote{Student ID: 210041265.}
\affiliation{
  \institution{Department of Computer Science and Engineering\\
  Islamic University of Technology (IUT), OIC}
  \city{Dhaka}
...
\email{muntasirhossain@iut-dhaka.edu}

\author{Rubaeeyat Hossain}
\authornote{Student ID: 210041266.}
\affiliation{
  \institution{Department of Computer Science and Engineering\\
  Islamic University of Technology (IUT), OIC}
  \city{Dhaka}
...
\email{rubaeeyathossain@iut-dhaka.edu}
